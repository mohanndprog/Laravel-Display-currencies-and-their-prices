...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('admin/assets/shortcuticon.svg') }}" type="image/x-icon">
    <!--begin::Fonts-->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Inter:300,400,500,600,700" />
    <!--end::Fonts-->
...
button#kt_ecommerce_add_product_submit {
    background: #FFBC13;
}
.bg-primary {
            ...
            <div id="kt_app_header" class="app-header">
                ...
                <div class="app-container container-fluid d-flex align-items-stretch justify-content-between">
                    ...
                    <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                        <a href="3" class="d-lg-none">
                            <img alt="Logo" src="{{ asset('admin/assets/shortcuticon.svg') }}" class="h-30px" />
                        </a>
                    </div>
                    <!--end::Mobile logo-->
                        ...
                        <div class="app-navbar flex-shrink-0">
                            ...
                            <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                ...
                                <div class="cursor-pointer symbol symbol-35px symbol-md-40px"
                                    ...
                                    data-kt-menu-placement="bottom-end">
                                    <img src="{{ asset('admin/assets/shortcuticon.svg') }}" alt="user" />
                                </div>
                                    ...
                                    <div class="menu-item px-3">
                                        <div class="menu-content d-flex align-items-center px-3">
                                            ...
                                            <div class="symbol symbol-50px me-5">
                                                <img alt="Logo" src="{{ asset('admin/assets/shortcuticon.svg') }}" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Username-->
                                            <div class="d-flex flex-column">
                                                <div class="fw-bold d-flex align-items-center fs-5">Goud
                                                    <span
                                                        class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Admin</span>
                                                </div>
                                                <a href="#"
                                                    class="fw-semibold text-muted text-hover-primary fs-7">info@goud.com</a>
                                            </div>
                                            <!--end::Username-->
                                        </div>
                                    </div>
                ...
                <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true"
                    ...
                    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
                        ...
                        <a href="{{ route('admin.home') }}">
                            <img alt="Logo" src="{{ asset('admin/assets/logo.svg') }}" width="150"
                    ...
                    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
                        ...
                        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3"
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link" href="{{ route('admin.coins.index') }}">
                                        <span class="menu-icon">
                    ...
                    <div class="app-sidebar-footer flex-column-auto pt-2 pb-6 px-6" id="kt_app_sidebar_footer">
                        <a href="{{ route('frontend.homepage') }}" target="_blank"
                            class="btn btn-flex flex-center btn-custom btn-primary overflow-hidden text-nowrap px-0 h-40px w-100">
                            <span class="btn-label">الذهاب للموقع الرئيسي</span>
